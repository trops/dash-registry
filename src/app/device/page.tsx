    ...
    return (
      <div className="text-center space-y-4">
        ...
        <p className="text-sm text-dash-muted">
          Your Dash app is now connected. You can close this page and return to
          the app.
        </p>
      </div>
    );
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-dash-muted text-center">
        This code expires in 15 minutes. If it has expired, restart the sign-in
        process in the Dash app.
      </p>
...
function AuthenticatedDeviceForm() {
  ...
  if (isAuthenticated) {
    return (
      <Suspense
        fallback={
          <div className="text-center text-dash-muted py-4">Loading...</div>
        }
      >
        <DeviceForm />
      </Suspense>
  ...
  return (
    <div className="max-w-md mx-auto px-6 py-12">
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-white mb-2">Connect Dash App</h1>
        <p className="text-dash-muted">
          Enter the code shown in your Dash app to connect your registry
          account.
        </p>
      </div>
