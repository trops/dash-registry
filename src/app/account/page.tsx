      ...
      {isAuthenticated && profile ? (
                        ...
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0">
                            ...
                            <button
                              ...
                              className="px-3 py-1.5 text-xs rounded border border-dash-border text-dash-muted hover:text-white hover:border-dash-accent transition-colors"
                            >
                              Edit
                            </button>
                          </div>
        ...
        <div className="space-y-6">
          <div className="p-8 rounded-lg bg-dash-surface border border-dash-border">
            ...
            {/* Custom "Sign in with Google" button — routes through
                AuthContext.signInWithGoogle so the Cognito-logout
                round-trip runs and Google shows the account picker.
                Amplify UI's built-in socialProviders Google button
                calls signInWithRedirect directly and bypasses our fix. */}
            <button
              type="button"
              onClick={() => signInWithGoogle()}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg bg-white text-gray-800 font-medium hover:bg-gray-100 transition-colors mb-4"
            >
