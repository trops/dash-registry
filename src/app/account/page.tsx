                ...
                <div className="space-y-6">
                    <div className="p-6 rounded-lg bg-dash-surface border border-dash-border">
                        ...
                        <p className="text-sm text-dash-muted mb-6">
                            Choose a username to get started. Your username
                            becomes the scope for all published packages (e.g.,
                            @yourname/my-widgets).
                        </p>
                        ...
                        <div className="space-y-4 max-w-md">
                            <div>
                                ...
                                />
                                <p className="text-xs text-dash-muted mt-1">
                                    Lowercase, starts with a letter, only
                                        ...
                                        Footer() {
                                            return (
                                                <div className="text-center text-xs text-dash-muted pb-4">
                                                    You can also sign in from
                                                    the Dash app using the
                                                    device code flow.
                                                </div>
                                            );
                                        },
